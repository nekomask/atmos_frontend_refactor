...
function LandingPage(props) {
  ...
  const getCities = () => {
    ...
    if (states[i].name === props.USState){
...
<select id="form-input-state" value={props.USState} onChange={handleChange}>
...
<option value="Wyoming">Wyoming</option>
        ...
        <form className="landing-form-container" onSubmit={props.getData}>
          ...
          <input type="text" name="city" id="form-input-city" placeholder="City" value={props.city} onChange={handleChange}
          />
