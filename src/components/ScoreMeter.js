...
export default function ScoreMeter(props)
{
  ...
  useEffect(() =>
  {
    if (props.score <= 50)
    {
      setCurrColor("rgba(146, 255, 132, 0)");
    ...
    {
      setCurrColor("rgba(254, 205, 31, 0)");
    ...
    {
      setCurrColor("rgba(135, 69, 220, 0)");
    ...
    {
      setCurrColor("rgba(100, 27, 135, 0)");
